...
Variants {
    ...
    Item {
        ...
        PanelWindow {
            ...
            id: dockWindow
            visible: Settings.settings.showDock && (Settings.settings.dockMonitors.includes(modelData.name) || Settings.settings.dockMonitors.length === 0)
            screen: modelData
                ...
                Item {
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                id: appButton
                                visible: modelData.screens.filter(screen => screen.name === dockWindow.screen.name).length > 0
