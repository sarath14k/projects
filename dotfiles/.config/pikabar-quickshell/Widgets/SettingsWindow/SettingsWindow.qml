...
PanelWithOverlay {
    ...
    // Function to show live wallpaper selector
    function showLiveWallpaperSelector() {
        if (liveWallpaperSelector)
            liveWallpaperSelector.show();
    }
        ...
        Rectangle {
            ...
            anchors {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            border.width: 1 * Theme.scale(screen)
                            visible: activeTabIndex === 6 && !Settings.settings.useLiveWallpaper
                        ...
                        // Live Wallpaper Selection Button
                        Rectangle {
                            width: 140 * Theme.scale(screen)
                            height: 32 * Theme.scale(screen)
                            radius: 16
                            color: liveWallpaperButtonArea.containsMouse ? Theme.accentPrimary : "transparent"
                            border.color: Theme.accentPrimary
                            border.width: 1 * Theme.scale(screen)
                            visible: activeTabIndex === 6 && Settings.settings.useLiveWallpaper
                            ...
                            Row {
                                ...
                                Text {
                                    text: "movie"
                                    font.family: liveWallpaperButtonArea.containsMouse ? "Material Symbols Rounded" : "Material Symbols Outlined"
                                    font.pixelSize: 16 * Theme.scale(screen)
                                    color: liveWallpaperButtonArea.containsMouse ? Theme.onAccent : Theme.accentPrimary
                                    anchors.verticalCenter: parent.verticalCenter
                                }
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    } else if (liveWallpaperSelector.visible) {
                                        liveWallpaperSelector.hide();
                                    } else {
                                        panelMain.dismiss();
                                    }
                                }
                ...
                Item {
                    ...
                    // Live Wallpaper Selector Component
                    LiveWallpaperSelector {
                        id: liveWallpaperSelector
                        anchors.fill: parent
                    }
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    if (liveWallpaperSelector.visible) {
                                        liveWallpaperSelector.hide();
                                    }
