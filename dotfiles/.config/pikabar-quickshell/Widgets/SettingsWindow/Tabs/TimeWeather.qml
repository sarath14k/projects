...
ColumnLayout {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ToggleOption {
                label: "Show Clock on Wallpaper"
                description: "Display a large transparent clock on your desktop wallpaper"
                value: Settings.settings.showDesktopClock
                onToggled: function() {
                    Settings.settings.showDesktopClock = !Settings.settings.showDesktopClock;
                }
            }
