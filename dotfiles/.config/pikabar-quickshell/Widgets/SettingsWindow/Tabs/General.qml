...
ColumnLayout {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ToggleOption {
                label: "Light Mode"
                description: "Switch between light and dark mode colors"
                value: Settings.settings.lightMode
                onToggled: function() {
                    Settings.settings.lightMode = !Settings.settings.lightMode;
                    var scheme = Settings.settings.lightMode ? "prefer-light" : "prefer-dark";
