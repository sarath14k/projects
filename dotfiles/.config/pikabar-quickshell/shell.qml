...
Scope {
    ...
    Loader {
        ...
        active: Settings.settings && Settings.settings.useLiveWallpaper
        sourceComponent: Component { 
            LiveBackground { 
                locked: lockScreen.locked
                panelsOpen: (root.settingsWindow !== null) || (overview.visible)
            } 
        }
    }
    ...
    Connections {
        ...
        function onLimitLiveWallpaperResChanged() {
            if (liveWallpaperLoader.active) {
                liveWallpaperLoader.active = false;
                liveWallpaperLoader.active = true;
            }
        }
    }
    Overview {}
